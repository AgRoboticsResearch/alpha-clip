...
model, preprocess = alpha_clip.load("ViT-L/14", alpha_vision_ckpt_pth="F:\doctor\AlphaCLIP\checkpoint\clip_l14_grit20m_fultune_2xe.pth", device=device)  # change to your own ckpt path  #
...
img_pth = 'F:\doctor\AlphaCLIP\image_wyn\straw_crop/1/1.png'
mask_pth = 'F:\doctor\AlphaCLIP\image_wyn\straw_crop/1/1_crop/3.png' # image-type mask
...
#text = alpha_clip.tokenize(["a goegously dressed woman", "a purple sleeveness dress", "bouquet of pink flowers"]).to(device)  #alpha原来的
text = alpha_clip.tokenize(["red strawberry", "green strawberry", "flower", "leaf"]).to(device)
